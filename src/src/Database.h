 ...
 *
 * Allows nearest_ne() to use nearest() from utilities.h,
...
public:
     ...
     */
    StoichZbar(const StoichZbar &o);

    /// Destructor (DON'T "delete dp;")
    ~StoichZbar(void);
     ...
     */
    const StoichZbar & operator =(const StoichZbar &o);
...
public:
     ...
     */
    std::string get_tops_cmnd(void) const;
     ...
     */
    bool get_tops_default(void) const;
     ...
     */
    size_t get_nbits_te(void) const;
     ...
     */
    size_t get_nbits_tr(void) const;
     ...
     */
    size_t get_nbits_neman(void) const;
     ...
     */
    size_t get_nbits_neexp(void) const;
     ...
     */
    size_t get_nbits_ne(void) const;
