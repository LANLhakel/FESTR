...
void Node::seti(const size_t iin) {i = iin;}

//-----------------------------------------------------------------------------

size_t Node::geti(void) const {return i;}

//-----------------------------------------------------------------------------

void Node::setr(const Vector3d &rin) {r = rin;}

//-----------------------------------------------------------------------------

Vector3d Node::getr(void) const {return r;}

//-----------------------------------------------------------------------------

void Node::setv(const Vector3d &vin) {v = vin;}

//-----------------------------------------------------------------------------

Vector3d Node::getv(void) const {return v;}
