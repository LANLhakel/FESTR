#ifndef LANL_ASC_PEM_UTILS_H_
#define LANL_ASC_PEM_UTILS_H_
...
/**
  ...
  */
static double radians(const double x);
...
/**
  ...
  */
static double degrees(const double x);
...
/**
  ...
  */
static int nint(const double x);
...
/**
  ...
  * @return Trimmed str
  */
static std::string trim_char(std::string str, const char c);
...
/**
  ...
  * @return Trimmed str
  */
static std::string trim_line_breaks(std::string str);
...
/**
  ...
  */
static std::string double_to_string(const double x);
...
/**
  ...
  */
template<typename T>
static int sign_eqt(const T x, const double EQT)
{
...
/**
  ...
  */
static RetQuad solve_quadratic(const double a, const double b,
 ...
 */
static void find_line(std::ifstream &istr, const std::string &str);
 ...
 */
static void find_word(std::ifstream &istr, const std::string &str);
...
static size_t bisect(const double x, const T &v, size_t ilow, size_t ihigh)
{
    size_t imid;
    while (ihigh - ilow > 1)
    {
...
/**
  ...
  */
template<typename T> // T must support "double operator [](size_t)" method
static void bracket(const double x, const T &v,
...
/**
  ...
  */
template<typename T> // T must support "double operator [](size_t)" method
static size_t nearest(const double x, const T &v,
...
/**
  ...
  */
template<typename T> // T must support "double operator [](size_t)" method
static size_t nearest_exh(const double x, const T &v, const size_t n)
...
/**
  ...
  */
static std::string fname_root(const std::string &material,
...
/**
  ...
  */
template<typename T> // T must support "double operator [](size_t)" method
static void load_array(const std::string &fname, const size_t n,
...
/**
  ...
  */
static void load_eos(const std::string &fname, const size_t n,
...
/**
  ...
  */
static double ne_charge_neut(const double np, const unsigned short int nmat,
...
/**
  ...
  */
static double fitlin(const double x,
...
/**
  ...
  */
static double fitpoint(const double x,
                       const double x1, const double y1,
                       const double x2, const double y2,
...
/**
  ...
  */
static std::vector<double> get_grid(const double xlow, const double xhigh,
...
static void syngrids(const Txin &xin, const Tyin &yin, const size_t NIN,
                     const std::string &xmode, const std::string &ymode,
...
// T's must support "double operator [](size_t)" methods
static void scale_y(const Thv &hv, const Tsc &sc, const size_t NIN,
                    const std::string &xmode, const std::string &ymode,
                    const Txout &xout, Tyout &yout, const size_t NOUT)
{
...
// T's must support "double operator [](size_t)" methods
static void shift_x(const Thvold &hvold, const Thvnew &hvnew, const size_t NIN,
...
// T's must support "double operator [](size_t)" methods
static void rescale(const Thvold &hvold, const Tsc &sc,
...
/**
  ...
  */
static void first_difference(const std::string &s1, const std::string &s2);
...
/**
  ...
  */
static double planckian(const double hv, const double tev);
...
/**
  ...
  */
static std::string bool_to_string(const bool b);
...
/**
  ...
  */
static bool string_to_bool(std::string b);
...
/**
  ...
  */
static size_t many_to_one(const std::vector<size_t> &dim,
...
/**
  ...
  */
static std::vector<size_t> one_to_many(const std::vector<size_t> &dim,
                                       size_t j);
...
/**
  ...
  */
static size_t two_to_one(const std::vector<size_t> &dim,
...
/**
  ...
  */
static std::pair<size_t, size_t> one_to_two(const std::vector<size_t> &dim,
                                            size_t j);
...
/**
  ...
  */
static double gaussian(const double x, const double mu, const double sigma);
...
static double integrate_trapezoid(double a, double b,
...
/**
  ...
  */
template<typename Txin, typename Tyin, typename Txout, typename Tyout>
// T's must support "double operator [](size_t)", "size_t size()" methods
static void convolution(const double fwhm, const Txin &xin, const Tyin &yin,
...
/**
  ...
  * @return true or false
  */
static bool is_contained_in(const double x,
 ...
 */
static void replace_in_string(std::string &s, const std::string &old,
                                              const std::string &rep);

//-----------------------------------------------------------------------------

/**
 * @brief Normalize vector elements to add up to a given number (default = 1)
 * @param[in] f Vector of doubles
 * @param[in] n Normalization target (optional, default = 1)
 * @return Vector elements normalized to add up to a given number (default = 1)
 */
static std::vector<double> normalize(const std::vector<double> &f,
                                     const double n = 1.0);
