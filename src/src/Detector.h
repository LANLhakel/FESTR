...
//-----------------------------------------------------------------------------
     ...
     * @param[in] back_value_in Initializes Detector::back_value
     * @param[in] tracking_in Initializes Detector::tracking
     */
    Detector(const size_t freq_patch_in,
             ...
             const std::string &back_type_in, const double back_value_in,
             const bool tracking_in);
     ...
     */
    Vector3d get_ux(void) const;

    /**
     * @brief Getter for Detector::uy
     * @return Neighboring Ray spacing vector
     */
    Vector3d get_uy(void) const;
     ...
     * @param[in] nt Number of time intervals
     * @param[in] ntd Number of digits needed to represent Hydro::ntimes
     * @param[in] h Reference to Hydro object
     */
    void yt_to_files(Progress *parent, Goal &gol,
                     const size_t nt, const int ntd, const Hydro &h);

    /**
     * @brief Calculate Detector::yst in the MPI-parallel mode
     * @param[in] nt Number of time intervals
     * @param[in] ntd Number of digits needed to represent Hydro::ntimes
     * @param[in] h Reference to Hydro object
     */
    void yst_using_mpi(const size_t nt, const int ntd, const Hydro &h);
