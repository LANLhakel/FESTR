...
void test_utilities(int &failed_test_count, int &disabled_test_count)
{

const std::string GROUP = "utilities";
...

{
    ...
    if (t.is_enabled())
    {
        std::string fname(cnst::PATH + "UniTest/text_file.txt");
...

{
    ...
    if (t.is_enabled())
    {
        ...
        std::string tr_str = "00000";
        std::string ne_str = "8.0e24";
        std::string path(cnst::PATH + "UniTest/Dbase2/spectra/");
...

{
    ...
    if (t.is_enabled())
    {
        ...
        std::string tr_str = "00000";
        std::string ne_str = "8.0e24";
        std::string path(cnst::PATH + "UniTest/Dbase2/eos/");
        std::string fname = path + material + "/"
                          + utils::fname_root(material, te_str, tr_str, ne_str)
                          + sp;
...

{
    ...
    {
        const size_t n = 51;
        std::string fname(cnst::PATH + "UniTest/sp_unit.dat");
...

{
    ...
    if (t.is_enabled())
    {
        ...
        std::string fname(cnst::PATH + "UniTest/sp_unit.dat");
        std::ifstream infile(fname.c_str());
        fname = cnst::PATH + "UniTest/sp_unit10.dat";
...

{
    ...
    {
        const size_t n = 2801;
        std::string fname(cnst::PATH + "UniTest/sp_full.dat");
        std::ifstream infile(fname.c_str());
        std::vector<double> x(n), y(n), e(n), a(n);
        for (size_t i = 0; i < n; ++i) infile >> x.at(i) >> y.at(i);
        e = y;
...

{
    ...
    if (t.is_enabled())
    {
        ...
        std::string fname(cnst::PATH + "UniTest/sp_full.dat");
        std::ifstream infile(fname.c_str());
        fname = cnst::PATH + "UniTest/sp_full50.dat";
        std::ifstream expfile(fname.c_str());
        std::vector<double> x(n), y(n), e(n), a(n);
        for (size_t i = 0; i < n; ++i)
        {
